...
ALTER TABLE public.verification_codes ADD user_id INT NOT NULL,
	ADD CONSTRAINT fk_verification_codes_users FOREIGN KEY(user_id) REFERENCES public.users(id);
